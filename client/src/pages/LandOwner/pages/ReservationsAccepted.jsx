...
export default function ReservationsAccepted() {
const [ change, setChange] = useState('Decline');

const handleClick = () => {
    setChange(change === 'Decline' ? 'Accepted' : 'Decline');
}
   ...
   <div className="flex mt-5 gap-44 ml-72">
    ...
    <div>
     ...
     {change === 'Decline'?
       (
        <div>
       <button className="border p-1 -mt-1 rounded-md text-white bg-rose-500 shadow-md  hover:shadow-rose-500 duration-300 ease-in-out">Declined</button>
       </div>  
         )
       :
       (
